...
def price(request):
    ...
    if STD_DAY=='오늘' or '현재':
        ...
        index = 0
        daycheck = 0
    elif STD_DAY=='일주일전' or '지난주':
        days = -7
        index = 5
        daycheck = 1
    elif STD_DAY=='한달전' or '지난달':
        days = -35
        index = 25
        daycheck = 1
    elif STD_DAY=='내일':
    ...
    past_price = kamis_json['data']['item'][0]['price'] #과거
    now_price = kamis_json['data']['item'][index]['price'] #현재 (일주일전에서 현재가격으로 오려면 [5](주말빼서)
